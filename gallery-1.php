    ...
    <div class="container">      
	 ...
	 <div class="col-md-3" style="margin-left:-90px;"><div style="background:#efefef; margin-top:35px;"><?php include("scroll-top.php")?></div></div>
        <div class="col-md-8 bg-cnt">   
            <b>
              <h3 class="div-title" data-text="About Us" style="color:#cc3333; font-size:21px;">Gallery</h3>
             </b>
			 
		     <article class="post" style="margin-top:-10px;>
			                  <div class="post-media">
                                <ul class="slider">
                                    <li><img src="img/thumbs/placeholder3.jpg" alt="..."></li>
                                    <li><img src="img/thumbs/placeholder2.jpg" alt="..."></li>
                                    <li><img src="img/thumbs/placeholder1.jpg" alt="..."></li>
                                </ul>
                            </div>
                        </article>
