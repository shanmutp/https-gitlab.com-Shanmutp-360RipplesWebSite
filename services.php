...
<head>
    ...
    <title>Services :: 360 Ripples Solution Pvt Ltd - Ripples of Excellence</title>
    ...
    <div class="container">      
	  ...
	  <div class="col-md-2" style="background:#FFFFFF"><div style="background:#efefef; margin-top:35px;"><?php include("scroll-top.php")?></div></div>
        <div class="col-md-7" style="background:#FFFFFF">
           
            <b>
              <span class="small" style="font-size:60px;">Our</span>
              <span class="large" style="font-size:100px;color:#dc2440;">Services</span> 
            </b>
             <h3 class="div-title" data-text="About Us">Service Offering</h3>
        ...
        <div class="col-md-3" style="background:#0033CC;">
