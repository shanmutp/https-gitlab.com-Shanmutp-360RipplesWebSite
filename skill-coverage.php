...
<head>
    ...
    <title>Skill Coverage :: 360 Ripples Solution Pvt Ltd - Ripples of Excellence</title>
    ...
    <div class="container">      
      ...
      <div class="row">
		...
		<div class="col-md-8" style="background-color:white;" align="center" > 
	<p style="height:20px;"></p>  
	  	
		
	  <img src="img/skill.png" alt="Skill Coverage" width="84%"  >
	  
    
        <div class="col-md-2">
		<!--<div style="margin-top:35px; background-color:#0099FF;"><img src="img/1.png" alt="about us">
