    ...
    <div class="container">      
	  ...
	  <div class="col-md-3" style="margin-left:-90px;"><div style="background:#efefef; margin-top:35px;"><?php include("scroll-top.php")?></div></div>
        <div class="col-md-8 bg-cnt" style="padding-bottom:130px;">
            ...
            <b>
              <span class="small" style="font-size:25px;font-weight:bold;">Contact Us</span>
             </b>
...
<a class="btn btn-black btn-default" style="float:right;" href="#send">Send your details</a>
                        </address>
                        <address class="address">
...
Tamilnadu.
						...
						<h3 style="text-align:center" id="send"> 
						 Send your details for <br>our experts to reach you.</h3>
						<div class="form-detached">
                            <form action="contact-success.php" method="post">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" value="" placeholder="Organization/Academy Name" data-msg-required="Please enter your name." name="oname" id="oname" required>
                                </div>
                                </div>
								 <div class="col-md-6">
                                	<div class="form-group">
                                    <label class="sr-only" for="name"></label>
                                    <input type="text" class="form-control" value="" placeholder="Name" data-msg-required="Please enter your name." name="name" id="name" required>
                                </div>
                                </div>
								<div class="col-md-6">
                                	<div class="form-group">
                                    <label class="sr-only" for="name"></label>
                                    <input type="text" class="form-control" value="" placeholder="Contact Number" data-msg-required="Please enter your name." name="phone" id="phone" required>
                                </div>
                                </div>
								<div class="col-md-6">
                                	<div class="form-group">
                                    <label class="sr-only" for="name"></label>
                                <select class="form-control" name="technology" style="color:#a2a299;" required><option style="color:#a2a299;"><span style="color:#a2a299;">Title</span></option><option>Student</option><option> Corporate Representative</option> <option>Employee</option> <option>Academy Representative</option> <option>Others</option></select>
								 </div>
                                </div>
								<div class="col-md-6">
                                	<div class="form-group">
                                    <label class="sr-only" for="name"></label>
                                    <input type="text" class="form-control" value="" placeholder="Email ID" data-msg-required="Please enter your name." name="email" id="email" required>
                                </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea placeholder="Enter your message..." data-msg-required="Please enter your message." rows="6" class="form-control" name="address" id="address" required></textarea>
                                </div>
                                 <input type="submit" value="Send Message" class="btn btn-default alignleft">
