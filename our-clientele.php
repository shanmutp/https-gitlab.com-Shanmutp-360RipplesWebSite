...
<head>
    ...
    <title>Our Clientele  :: 360 Ripples Solution Pvt Ltd - Ripples of Excellence</title>
    ...
    <div class="container">      
      ...
      <div class="row">
        ...
        <div class="col-md-8 bg-cnt">
            ...
            <b>
              <span class="small" style="font-size:35px; color:#dc2440;">Our Clientele</span>
             </b>
			 <p style="height:20px;"></p>
			 <div class="row">
                    <div class="col-md-3">
                        <img src="img/placement-logo.jpg" alt="logo">
                    </div>
